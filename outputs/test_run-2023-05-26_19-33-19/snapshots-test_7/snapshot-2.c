...
{{0x73B54D6EL,0x73B54D6EL,0x73B54D6EL,0x73B54D6EL,0x73B54D6EL,0x73B54D6EL,0x73B54D6EL,0x73B54D6EL}}
  ...
  static int8_t func_1(void) {
     ...
     for (i = 0;
 i < 1;
 i++)     {         for (j = 0; j < 3; j++)             l_2[i][j] = 2L;     }
     for (g_3 = 0;
 (g_3 <= 0);
 g_3 += 1)     {         uint32_t l_20[1][5][4] = {{{0UL,0x79A7B445L,0UL,0x79A7B445L},{0UL,0x79A7B445L,0UL,0x79A7B445L},{0UL,0x79A7B445L,0UL,0x79A7B445L},{0UL,0x79A7B445L,0UL,0x79A7B445L},{0UL,0x79A7B445L,0UL,0x79A7B445L}}};         uint8_t *l_21[3];         int32_t l_31[4][4] = {{1L,1L,5L,1L},{1L,0x261718BCL,0x261718BCL,1L},{0x261718BCL,1L,0x261718BCL,0x261718BCL},{1L,1L,5L,1L}};         uint8_t **l_389 = &g_114;         uint8_t **l_390 = &l_21[2];         int32_t l_392[7] = {(-1L),(-1L),(-1L),(-1L),(-1L),(-1L),(-1L)};         uint32_t *l_487 = &g_209;         int64_t *l_677 = (void*)0;         int64_t *l_678 = &g_109;         uint8_t l_679 = 0x9CL;         int32_t *l_681 = &l_392[1];         int32_t l_693[7][1][9] = {{{0xDD709E06L,4L,7L,4L,0xDD709E06L,(-7L),0xD8835874L,0x4A59FC96L,0x5DBC0755L}},{{5L,(-6L),(-3L),(-9L),0xBC25568DL,(-9L),(-3L),(-6L),5L}},{{0xC174B36BL,0x38E64998L,0x51CA2F0FL,0xDD709E06L,0x4A59FC96L,(-7L),0x6DE86D87L,(-7L),0x4A59FC96L}},{{0x092118AAL,(-9L),(-9L),0x092118AAL,(-9L),0xF2AD5169L,0xF4E74B14L,5L,0xAA6C9BEAL}},{{0xC174B36BL,0x4A59FC96L,0x6DE86D87L,0x17816718L,0x17816718L,0x6DE86D87L,0x4A59FC96L,0xC174B36BL,7L}},{{5L,0x4D6457C2L,0xAA6C9BEAL,1L,(-9L),5L,5L,(-9L),1L}},{{0xDD709E06L,0xD8835874L,0xDD709E06L,0x38E64998L,0x4A59FC96L,0x17816718L,0x151C65D8L,7L,7L}}};         int i, j, k;         for (i = 0; i < 3; i++)             l_21[i] = &g_22;     }
     return l_1160;
 }
  int main (void) {
     int i, j, k;
     ...
     for (i = 0;
 i < 1;
 i++)     {         for (j = 0; j < 1; j++)         {             for (k = 0; k < 8; k++)             {                 csmith_sink_ = g_680[i][j][k];             }         }     }
     csmith_sink_ = g_758;
     csmith_sink_ = g_998;
     return 0;
 }

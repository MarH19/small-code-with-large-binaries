 ...
 int crc32_gentab_i;
 int crc32_gentab_j;
 static void crc32_gentab (void) {                                                         crc32_gentab_i = 0;                         for (0;               0 < 256;               crc32_gentab_i++) {               crc32_gentab_j = 8;                        for (crc32_gentab_j;             crc32_gentab_j > 0;             crc32_gentab_j--)                crc32_tab_0 = 1;              }               }
                                       int transparent_crc_flag;
         static void transparent_crc (  void) {                {                                                                                                                                                     {                              crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   1;                             }                                                               {                              crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   1;                             }                                                              }                transparent_crc_flag;                          {              }               }
                 ...
                 static uint8_t g_208[1] = {                    0x18250U,1U,0x26,0x1B,0x91,0x1B,0x261U       ,      0U,0U,255U,1U,0x1B1U,0xB1,0xF32U       ,      4U,0x57,0xF3,0xB1,0xF6,0x1B,0x571U,1U       ,      250U,4U,0xF3,0xF6,0xF3,4U,250U,0x91,1U       ,      250U,0x57,255U,4U,0x68,0x0C,0x1B,0x08,0U       ,      0x31,1U,0x0C,0x26,0x91,0x68,0x68,0x91,0x26       ,      0x97,0x31,0x97,1U,255U,0x68,0xF6,1U,0xF3       };
 ...
 __uint32_t func_1_l_1074[1][1][1] = {            {          {        0U,1U}          ,{        4294967293U,4294967295U}          ,{        4294967289U,4294967289U}          }            ,{          {        0x31663202,0x3057A298}          ,{        2336854783,1605114799}          ,{        4294967291U,0U}          ,{        0U,4285424079}          }            };
 ...
 int main (void) {                                                         {                         }                   main_i = 0;                               for (main_i;               main_i < 1;               main_i++)     {                     main_j = 0;                                    for (main_j;             main_j < 9;             main_j++)         {                       main_k = 0;                                         for (main_k;           main_k < 10;           main_k++)             {                                               0;                     }                   }                 }                   {                         }               }

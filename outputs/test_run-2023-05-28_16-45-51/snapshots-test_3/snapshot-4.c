...
static void transparent_crc ( char* vname, int flag) {
        crc32_8bytes(transparent_crc_val);
        if (flag) {
...
static uint32_t g_1007_0_0_0 = 0x63497A48;
   ...
   0U,0xFF6E61CF}
       ...
       g_3 -= 1)     {
           ...
           platform_main_begin();
           transparent_crc( "g_897", print_hash_value);
           transparent_crc( "g_947", print_hash_value);
     ...
     k < 10;
     k++)             {
                    transparent_crc( "g_1007[i][j][k]", print_hash_value);
                    if (print_hash_value) printf("index = [%d][%d][%d]\n", i, j, k);
                }
             }
          }
           transparent_crc( "g_1009", print_hash_value);
           platform_main_end( );
       }

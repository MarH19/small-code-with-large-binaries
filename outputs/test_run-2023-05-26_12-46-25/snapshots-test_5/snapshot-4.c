...
static void transparent_crc ( char* vname, int flag) {
        crc32_8bytes();
        if (flag) {
...
static uint64_t g_300_0 = 18446744073709551615UL;
     ...
     3,7L,-16,0x511E1152L,0xBCAEF4B9L,0x8183C4D5L};
           ...
           int32_t *l_297 = &l_294_3;
           int32_t *l_298 = &l_294_4;
           int32_t *l_299[2];
           int32_t *l_299_0;
           int i;
           for (i = 0;
       ...
       i++)         l_299_0 = (void*)0;
           ...
           int32_t *l_122 = &g_54;
           int32_t *l_123 = &g_105_4;
           int32_t *l_124 = &g_54;
           int32_t *l_125 = &g_105_3;
           int32_t *l_126[10][4] = {
     {
    &g_105_3,&g_105_5,&g_105_5,&g_105_3}
     ,{
    &g_105_3,&g_105_5,&g_105_5,&g_105_3}
     };
           int32_t *l_126_1_2 = &g_105_5;
           uint8_t l_127 = 0xFBL;
           return l_126_1_2;
       }
        int main (void) {
           ...
           transparent_crc( "g_24", print_hash_value);
           transparent_crc( "g_26", print_hash_value);
           transparent_crc( "g_54", print_hash_value);
           transparent_crc( "g_90", print_hash_value);
           transparent_crc( "g_96", print_hash_value);
           transparent_crc( "g_98", print_hash_value);
           transparent_crc( "g_100", print_hash_value);
           transparent_crc( "g_102", print_hash_value);
           transparent_crc( "g_104", print_hash_value);
           transparent_crc( "g_105.f0", print_hash_value);
           transparent_crc( "g_105.f1", print_hash_value);
           transparent_crc( "g_105.f2", print_hash_value);
     ...
     k < 5;
     k++)             {
                    transparent_crc( "g_229[i][j][k]", print_hash_value);
       ...
       i < 1;
       i++)     {
              transparent_crc( "g_300[i]", print_hash_value);

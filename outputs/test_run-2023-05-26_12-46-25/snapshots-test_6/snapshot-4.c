...
static uint64_t g_300_0 = 18446744073709551615UL;
    ...
    &g_105_3,&g_105_5,&g_105_5,&g_105_3}
        ...
        int main (void) {
           ...
           transparent_crc(g_105_0, "g_105.f0", print_hash_value);
           transparent_crc(g_105_1, "g_105.f1", print_hash_value);
           transparent_crc(g_105_2, "g_105.f2", print_hash_value);
     ...
     k < 5;
     k++)             {
                    transparent_crc(g_229_0_0_0, "g_229[i][j][k]", print_hash_value);
       ...
       i < 1;
       i++)     {
              transparent_crc(g_300_0, "g_300[i]", print_hash_value);
              if (print_hash_value) printf("index = [%d]\n", i);
          }
           platform_main_end( print_hash_value);
       }

...
&g_105.f3,&g_105.f5,&g_105.f5,&g_105.f3}
 ,{
&g_105.f5,&g_105.f3,&g_105.f5,&g_105.f5}
 ,{
&g_105.f3,&g_105.f3,&g_105.f5,&g_105.f3}
 ,{
&g_105.f3,&g_105.f5,&g_105.f5,&g_105.f3}
 };
       uint8_t l_127 = 0xFBL;
  ...
  j++)         {
             for (k = 0;
 k < 5;
 k++)             {                 transparent_crc(g_229[i][j][k], "g_229[i][j][k]", print_hash_value);                 if (print_hash_value) printf("index = [%d][%d][%d]\n", i, j, k);             }
         }
      }

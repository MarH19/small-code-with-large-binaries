      ...
      j--) ;
       ...
       g_288 = safe_add_func_uint16_t_u_u( ))     {
        ...
        static uint16_t func_13(uint32_t p_14, int16_t p_15, const uint8_t p_16, int32_t p_17) {
           ...
           if ((((p_14 <= (g_153 = (p_17 <= ((((safe_mod_func_uint16_t_u_u(((safe_add_func_uint32_t_u_u((safe_sub_func_int16_t_s_s(0x90EE, (safe_add_func_uint16_t_u_u( )))), 4294967289U)) ^ l_735), g_93)) == 1) | p_16) > p_15)))) || 0x38) < p_17))     {
              return g_93;
          }
       }
        static uint32_t func_18(uint32_t p_19, int16_t p_20, int32_t p_21, uint16_t p_22) {
           ...
           if ((safe_div_func_uint16_t_u_u((((g_153 , (((g_281 = ((safe_unary_minus_func_int8_t_s(l_338)) | p_20)) && (l_338 | ((safe_div_func_uint32_t_u_u( l_338)) & 1U))) ^ p_22)) && g_8) ^ g_332), l_338)))     {
          }
           else     {
              for (p_20 = (-21);
      (p_20 == 5);

  ...
  void  func_18(   void) {
                        ...
                        {                     {                             func_18___trans_tmp_4 =      ((safe_add_func_int32_t_s_s_si2 == 0) || ((safe_add_func_int32_t_s_s_si1 == (21474836471)) && (safe_add_func_int32_t_s_s_si2 == 0))) ?     ((safe_add_func_int32_t_s_s_si1)) :     (safe_add_func_int32_t_s_s_si1 % safe_add_func_int32_t_s_s_si2);                           }                                    for (func_18___trans_tmp_4;             (func_18___trans_tmp_4 == 5);             func_18___trans_tmp_4)         {                   }                 }
                               for (g_131;
               (g_131 < 52);
               g_131++)                  g_153;
               }
  ...
  void  func_48(    void) {
                                                  for (func_48_p_49;
               (func_48_p_49 != 27);
               ++func_48_p_49)     {                     {                             func_48___trans_tmp_5 =      ((safe_div_func_int32_t_s_s_si2 == 0) || ((safe_div_func_int32_t_s_s_si1 == (-2147483647-1)) && (safe_div_func_int32_t_s_s_si2 == (-1)))) ?     ((safe_div_func_int32_t_s_s_si1)) :     (safe_div_func_int32_t_s_s_si1 / safe_div_func_int32_t_s_s_si2);                           }                                    (((3U != (func_48___trans_tmp_5)) != 0xB0) <= 0x65);                 }
               }
                  int main (void) {

...
void func_13(void) {
  ...
  (((func_13_p_14 <=
     (g_153 = (func_13_p_17 <= ((((func_13___trans_tmp_2) == 1) |
                                 func_13_p_16) > func_13_p_15)))) ||
    0x38) < func_13_p_17);
}
void func_18(void) {
  {
    func_18___trans_tmp_3 =
        (safe_div_func_uint16_t_u_u_ui2 == 0)
            ? ((safe_div_func_uint16_t_u_u_ui1))
            : (safe_div_func_uint16_t_u_u_ui1 / safe_div_func_uint16_t_u_u_ui2);
  }
  {
    {
  ...
  for (g_131; (g_131 < 52); g_131++)
    g_153;
}
void func_40(void) {
  func_40_p_41 = ((unsigned int)(func_40_p_41) - (unsigned int)(9));
  for (func_40_p_41; (func_40_p_41 >= (27)); func_40_p_41)
    3024921553;
}
void func_48(void) {
  for (func_48_p_49; (func_48_p_49 != 27); ++func_48_p_49) {
    {
      func_48___trans_tmp_5 =
          ((safe_div_func_int32_t_s_s_si2 == 0) ||
           ((safe_div_func_int32_t_s_s_si1 == (-2147483647 - 1)) &&

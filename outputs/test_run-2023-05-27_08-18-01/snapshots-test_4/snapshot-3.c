...
static uint16_t (safe_div_func_uint16_t_u_u)( uint16_t ui2 ) {
         return     (ui2 == 0) ?     ((safe_div_func_uint16_t_u_u_ui1)) :     (safe_div_func_uint16_t_u_u_ui1 / ui2);
       }
...
static uint16_t (safe_rshift_func_uint16_t_u_s)(uint16_t left ) {
         return     ((((int)safe_rshift_func_uint16_t_u_s_right) < 0) || (((int)safe_rshift_func_uint16_t_u_s_right) >= 32)) ?     ((left)) :     (left >> ((int)safe_rshift_func_uint16_t_u_s_right));
       }
      ...
      j--) ;
       ...
       g_288 = safe_add_func_uint16_t_u_u( ))     {
        ...
        static uint16_t func_13(uint32_t p_14, int16_t p_15, const uint8_t p_16, int32_t p_17) {
           ...
           if ((((p_14 <= (g_153 = (p_17 <= ((((safe_mod_func_uint16_t_u_u( )) == 1) | p_16) > p_15)))) || 0x38) < p_17))     {
              return g_93;
          }
       }
        static uint32_t func_18(uint32_t p_19, int16_t p_20, int32_t p_21, uint16_t p_22) {
           ...
           if ((safe_div_func_uint16_t_u_u( l_338)))     {
          }
           else     {
              for (p_20 = (-21);
      (p_20 == 5);

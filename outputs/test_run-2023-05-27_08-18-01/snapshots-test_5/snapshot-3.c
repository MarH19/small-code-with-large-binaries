...
static uint8_t (safe_add_func_uint8_t_u_u)( uint8_t ui2 ) {
         return     (ui2 == 0) ?     ((safe_add_func_uint8_t_u_u_ui1)) :     (safe_add_func_uint8_t_u_u_ui1 % ui2);
       }
      ...
      j--) ;
       ...
       g_288 = safe_add_func_uint16_t_u_u(g_288, 4))     {
        ...
        static uint32_t func_18(uint32_t p_19, int16_t p_20, int32_t p_21, uint16_t p_22) {
           ...
           if ((safe_div_func_uint16_t_u_u((((g_153 , (((g_281 = ((safe_unary_minus_func_int8_t_s(l_338)) | p_20)) && (l_338 | ((safe_div_func_uint32_t_u_u((((safe_add_func_uint8_t_u_u( p_19)) < 65530U) < p_21), l_338)) & 1U))) ^ p_22)) && g_8) ^ g_332), l_338)))     {
          }
           else     {
              for (p_20 = (-21);
      (p_20 == 5);

 typedef signed char __int8_t;
        ...
        void  (safe_unary_minus_func_int32_t_s)(void ) ;
...
void  (safe_add_func_uint8_t_u_u)( void ) {
              (safe_add_func_uint8_t_u_u_ui2 == 0) ?     ((safe_add_func_uint8_t_u_u_ui1)) :     (safe_add_func_uint8_t_u_u_ui1 % safe_add_func_uint8_t_u_u_ui2);
       }
        uint8_t safe_lshift_func_uint8_t_u_s_left;
int safe_lshift_func_uint8_t_u_s_right;
void  (safe_lshift_func_uint8_t_u_s)( void ) {
              ((((int)safe_lshift_func_uint8_t_u_s_right) < 0) || (((int)safe_lshift_func_uint8_t_u_s_right) >= 32)) ?     ((safe_lshift_func_uint8_t_u_s_left)) :     (safe_lshift_func_uint8_t_u_s_left >> ((int)safe_lshift_func_uint8_t_u_s_right));
       }
        uint16_t safe_unary_minus_func_uint16_t_u_ui;
void  (safe_unary_minus_func_uint16_t_u)(void ) {
          -safe_unary_minus_func_uint16_t_u_ui;
       }
...
void  func_18(   void) {
           ...
           if ((__trans_tmp_3))     {
              ...
              {
                       __trans_tmp_4 =      ((safe_add_func_int32_t_s_s_si2 == 0) || ((safe_add_func_int32_t_s_s_si1 == (-2147483647-1)) && (safe_add_func_int32_t_s_s_si2 == (-1)))) ?     ((safe_add_func_int32_t_s_s_si1)) :     (safe_add_func_int32_t_s_s_si1 % safe_add_func_int32_t_s_s_si2);
                     }
              
              for (func_18_p_20 = (-21);
      (func_18_p_20 == 5);
      func_18_p_20 = __trans_tmp_4)         {
             }
          }
           for (g_131 = (-11);
       (g_131 < 52);
...
void  func_48(    void) {
       ...
       ++func_48_p_49)     {
              ...
              if ((((l_66 != (__trans_tmp_5)) != 0xB0) <= l_65))         {
                  func_48_p_52;
             }
          }
       }

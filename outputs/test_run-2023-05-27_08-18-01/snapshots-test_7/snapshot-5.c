...
static uint16_t func_13(   int32_t p_17) {
           uint32_t l_734 = 4294967286U;
           int32_t l_735 = 0x4084D062;
           if ((((func_13_p_14 <= (g_153 = (p_17 <= ((((safe_mod_func_uint16_t_u_u( )) == 1) | func_13_p_16) > func_13_p_15)))) || 0x38) < p_17))     {
              return g_93;
          }
       }
...
static int8_t func_56(const int32_t p_57,  uint8_t p_59, uint16_t p_60) {
           return p_60;
       }
        int main (void) {

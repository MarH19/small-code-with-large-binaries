...
static uint8_t (safe_lshift_func_uint8_t_u_u)( unsigned int right ) {
         return     ((((unsigned int)right) >= 32) || (safe_lshift_func_uint8_t_u_u_left > ((255) >> ((unsigned int)right)))) ?     ((safe_lshift_func_uint8_t_u_u_left)) :     (safe_lshift_func_uint8_t_u_u_left << ((unsigned int)right));
       }

...
void  (safe_add_func_int16_t_s_s)(void ) {
         int16_t si1 = 0;
              (si1 + safe_add_func_int16_t_s_s_si2);
       }
        int16_t safe_mod_func_int16_t_s_s_si2;
void  (safe_mod_func_int16_t_s_s)(void ) {
         int16_t si1 = 0;
              ((safe_mod_func_int16_t_s_s_si2 == 0) || ((si1 == (-32767-1)) && (safe_mod_func_int16_t_s_s_si2 == 0))) ?     ((si1)) :     (si1 % safe_mod_func_int16_t_s_s_si2);
       }
...
static uint16_t g_110_0 = 0xF411L;
      ...
      0xA347EEFFL,0xA347EEFFL,0xA347EEFFL};
        ...
        static int64_t *g_318[8] = {&g_183,&g_183,&g_183,&g_183,&g_183,&g_183,&g_183,&g_183};
static int64_t **g_318_1 = &g_319;
        static int64_t **g_317 = &g_319;

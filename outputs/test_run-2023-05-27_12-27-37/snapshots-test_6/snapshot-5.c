...
static int16_t (safe_mod_func_int16_t_s_s)( int16_t si2 ) {
         return     ((si2 == 0) || ((safe_mod_func_int16_t_s_s_si1 == (-32767-1)) && (si2 == 0))) ?     ((safe_mod_func_int16_t_s_s_si1)) :     (safe_mod_func_int16_t_s_s_si1 % si2);
       }
...
static uint8_t g_580_0_0 = 0xF93774A1L;
      ...
      g_91 += 1)         {
                 ...
                 int32_t *l_291[1];
                 uint32_t *l_341 = &g_91;
                 if (((safe_add_func_uint32_t_u_u((safe_sub_func_uint32_t_u_u((((safe_add_func_int8_t_s_s( )) , (safe_mod_func_int16_t_s_s( g_251))) && l_299[0][1][1]), l_273)), l_282)) , 0x04123013L))             {

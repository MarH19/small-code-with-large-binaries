...
static int16_t (safe_mod_func_int16_t_s_s)(int16_t si1 ) {
         return     ((safe_mod_func_int16_t_s_s_si2 == 0) || ((si1 == (-32767-1)) && (safe_mod_func_int16_t_s_s_si2 == 0))) ?     ((si1)) :     (si1 % safe_mod_func_int16_t_s_s_si2);
       }
...
static uint8_t (safe_mul_func_uint8_t_u_u)(uint8_t ui1 ) {
         return ((unsigned int)ui1) * ((unsigned int)safe_mul_func_uint8_t_u_u_ui2);
       }

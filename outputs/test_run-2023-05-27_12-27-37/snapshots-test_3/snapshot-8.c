     ...
     void  func_30( void) {
       ...
       1)             {
                     (unsigned long)(((1 + 2))*7+4+(1 + 3));
                                           {                        __uint32_t l_189;                        int32_t l_211 = 0x3B609C62L;                        i = 0;                                                for (0;    0 < 1;    i++)                     {                        }                        (void) sizeof ((&l_211 == &l_210 || &l_211 == &g_83) ? 1 : 0);                                                ( __extension__ ({    &l_211 == &l_210 || &l_211 == &g_83;         ;     ;    }   ));                    }
                 }
               }
             }
           }

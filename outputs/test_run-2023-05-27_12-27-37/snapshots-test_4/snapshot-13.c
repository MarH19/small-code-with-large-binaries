        ...
        void  (safe_lshift_func_uint8_t_u_u)( void ) {
                     ((((unsigned int)safe_lshift_func_uint8_t_u_u_right) >= 32) || (safe_lshift_func_uint8_t_u_u_left > (0 >> ((unsigned int)safe_lshift_func_uint8_t_u_u_right)))) ?     ((safe_lshift_func_uint8_t_u_u_left)) :     (safe_lshift_func_uint8_t_u_u_left << ((unsigned int)safe_lshift_func_uint8_t_u_u_right));
              }
...
void  func_19(void) {
                  ...
                  __uint32_t *l_343 = &func_19_l_344;
                  int32_t *l_375 = &func_19_l_293_0;
                  signed char l_385;
                  const __uint64_t l_426;
                  int i, j, k;
                  i = 0;
                              for (0;
              0 < 1;
              ...
              func_19___trans_tmp_1)     {
                    unsigned short l_274;
                    
                    int32_t l_298 = 0xC7C4E01AL;
                    int32_t l_299 ;
                    __uint32_t l_300 = 18446744073709551615UL;
                                   g_91 += 1;
                                   for (1;
            1 < 3;
            1)         {
                      ...
                      int32_t l_291;
                      __uint32_t *l_341 = &g_91;
                      (safe_add_func_uint32_t_u_u( ));
                                        ( 0x04123013L);
                                         {
                        (void) sizeof ((l_343 == l_341) ? 1 : 0);
                                             ( __extension__ ({
      }
       ));
                    }
        ...
        void  func_30( void) {
          ...
          1)             {
                        (unsigned long)(((1 + 2))*7+4+(1 + 3));
                                              {
                          __uint32_t l_189;
                          int32_t l_211 = 0x3B609C62L;
                                                  for (0;
      0 < 1;
      i++)                     {
                          }
                          (void) sizeof ((&l_211 == &l_210 || &l_211 == &g_83) ? 1 : 0);
                      }
                    }
                  }
                }

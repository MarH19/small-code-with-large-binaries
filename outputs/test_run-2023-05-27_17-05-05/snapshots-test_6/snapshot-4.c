...
static int8_t (safe_mod_func_int8_t_s_s)( int8_t si2 ) {
         return     ((si2 == 0) || ((safe_mod_func_int8_t_s_s_si1 == (-128)) && (si2 == (-1)))) ?     ((safe_mod_func_int8_t_s_s_si1)) :     (safe_mod_func_int8_t_s_s_si1 % si2);
       }
...
static int8_t (safe_lshift_func_int8_t_s_u)(int8_t left ) {
         return     ((left < 0) || (((unsigned int)safe_lshift_func_int8_t_s_u_right) >= 32) || (left > ((127) >> ((unsigned int)safe_lshift_func_int8_t_s_u_right)))) ?     ((left)) :     (left << ((unsigned int)safe_lshift_func_int8_t_s_u_right));
         return     ((left < 0) || (((int)safe_lshift_func_int8_t_s_u_right) < 0) || (((int)safe_lshift_func_int8_t_s_u_right) >= 32))?     ((left)) :     (left >> ((int)safe_lshift_func_int8_t_s_u_right));
       }
        ...
        static uint16_t func_1(void) {
           ...
           uint8_t *l_784 = &g_584;
           int8_t *l_785 = &g_324;
           if ((safe_add_func_int8_t_s_s( ((1UL ^ 1L) & (((void*)0 != l_779) < (safe_lshift_func_int8_t_s_s(((**g_736) = (-5L)), ((*l_785) = (safe_rshift_func_uint8_t_u_s(((*l_784) = g_100), l_778))))))))))     {

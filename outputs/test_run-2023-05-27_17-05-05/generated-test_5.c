...
static __uint32_t a = 4294967295UL;
static int32_t const b = (1L);
static __uint64_t g_43 = 12391587259980242745LL;
unsigned char func_1___trans_tmp_2;
void(safe_mod_func_int64_t_s_s)(void) {
  (0 || ((safe_mod_func_int64_t_s_s_si1 == (23372036854775807L - 1)) &&
         (safe_mod_func_int64_t_s_s_si2 == 0)))
      ?: (safe_mod_func_int64_t_s_s_si1 % safe_mod_func_int64_t_s_s_si2);
}
void(safe_mul_func_uint8_t_u_u)(void) {
  (safe_mul_func_uint8_t_u_u_ui1) *
      ((unsigned int)safe_mul_func_uint8_t_u_u_ui2);
}
void(safe_lshift_func_uint8_t_u_s)(void) {
  ((((int)safe_lshift_func_uint8_t_u_s_right) < 0) ||
   (((int)safe_lshift_func_uint8_t_u_s_right) >= 32) ||
   (safe_lshift_func_uint8_t_u_s_left >
    (0 >> ((int)safe_lshift_func_uint8_t_u_s_right))))
      ? ((safe_lshift_func_uint8_t_u_s_left))
      : (safe_lshift_func_uint8_t_u_s_left
         << ((int)safe_lshift_func_uint8_t_u_s_right));
  ((((unsigned int)safe_lshift_func_uint8_t_u_s_right) >= 32) ||
   (safe_lshift_func_uint8_t_u_s_left >
...
void(safe_rshift_func_uint8_t_u_s)(void) {
  ((((int)safe_rshift_func_uint8_t_u_s_right) < 0) ||
...
void(safe_lshift_func_uint16_t_u_u)(void) {
  ((((unsigned int)safe_lshift_func_uint16_t_u_u_right) >= 32) ||
   (safe_lshift_func_uint16_t_u_u_left >
    ((65535) >> ((unsigned int)safe_lshift_func_uint16_t_u_u_right))))
      ? ((safe_lshift_func_uint16_t_u_u_left))
      : (safe_lshift_func_uint16_t_u_u_left
         << ((unsigned int)safe_lshift_func_uint16_t_u_u_right));
}

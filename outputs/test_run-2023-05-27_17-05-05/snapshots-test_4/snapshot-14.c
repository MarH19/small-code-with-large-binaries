                ...
                int32_t safe_add_func_int32_t_s_s_si2;
                         ...
                         __int64_t safe_add_func_int64_t_s_s_si1safe_sub_func_int64_t_s_s_si1;
                ...
                void  (safe_mod_func_int64_t_s_s)( void ) {
                            (0 || ((safe_mod_func_int64_t_s_s_si1 == (23372036854775807L -1)) && (safe_mod_func_int64_t_s_s_si2 == 0))) ?      :     (safe_mod_func_int64_t_s_s_si1 % safe_mod_func_int64_t_s_s_si2);
                     }
                ...
                void  (safe_lshift_func_uint8_t_u_s)( void ) {
                            ...
                            ((((unsigned int)safe_lshift_func_uint8_t_u_s_right) >= 32) || (safe_lshift_func_uint8_t_u_s_left > (0 >> ((unsigned int)safe_lshift_func_uint8_t_u_s_right)))) ?     ((safe_lshift_func_uint8_t_u_s_left)) :     (safe_lshift_func_uint8_t_u_s_left << ((unsigned int)safe_lshift_func_uint8_t_u_s_right));
                     }

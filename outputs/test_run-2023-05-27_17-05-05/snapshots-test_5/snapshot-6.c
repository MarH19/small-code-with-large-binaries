  ...
  void  (safe_mod_func_uint64_t_u_u)( void ) {
          ...
          static unsigned short g_286 = 65535UL;
          static signed char g_324 = 0xFAL;
          static signed char g_346 = 0xD9L;
          static __uint64_t g_399 = 0xA772BE76DCB0C7B2LL;
          ...
          void  func_1(void) {
            ...
            unsigned short l_779 = 65535UL;
            unsigned char l_784 = 0x78L;
            signed char l_785 = 0xFAL;
            {                                          __trans_tmp_1 =      (safe_add_func_int8_t_s_s_si1 + 0);                   }
                        (__trans_tmp_1);
                         {                              {                        __trans_tmp_2 =      (safe_mod_func_uint8_t_u_u_ui2 == 0) ?     ((safe_mod_func_uint8_t_u_u_ui1)) :     (safe_mod_func_uint8_t_u_u_ui1 % safe_mod_func_uint8_t_u_u_ui2);                      }                              (((*g_737) = (__trans_tmp_2)) ^ 0UL);                               ;           }

...
static int64_t (safe_mod_func_int64_t_s_s)( int64_t si2 ) {
         return     ((si2 == 0) || ((safe_mod_func_int64_t_s_s_si1 == (-9223372036854775807L -1)) && (si2 == (-1)))) ?     ((safe_mod_func_int64_t_s_s_si1)) :     (safe_mod_func_int64_t_s_s_si1 % si2);
       }
        ...
        static uint16_t func_1(void) {
           ...
           if ((safe_add_func_int8_t_s_s( ((1UL ^ 1L) & (((void*)0 != l_779) < (safe_lshift_func_int8_t_s_s( )))))))     {
              ...
              if ((((*g_737) = (safe_mod_func_uint8_t_u_u(((*l_784) = 0xDEL), ((safe_add_func_uint32_t_u_u((*g_678), (0xECL > (((safe_mul_func_uint16_t_u_u(0x1CD5L, (safe_mod_func_int64_t_s_s( l_794)))) ^ (safe_sub_func_uint64_t_u_u(((&g_286 != &g_121) || 0x85L), (*g_399)))) < l_794)))) && l_794)))) ^ 0UL))         ;
          }
           for (g_5 = 0;
       (g_5 <= (-24));

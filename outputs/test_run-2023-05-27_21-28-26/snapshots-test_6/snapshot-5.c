...
static uint32_t crc32_tab_0;
      ...
      j--) {
        ...
        int main (void) {
           ...
           transparent_crc(65532U, "g_16", print_hash_value);
           transparent_crc(0x6D0374C7, "g_17", print_hash_value);
           transparent_crc(6, "g_23", print_hash_value);
           transparent_crc(0x0E, "g_32", print_hash_value);
           transparent_crc(0x922C, "g_69", print_hash_value);
           transparent_crc(0xE69C17F7, "g_84", print_hash_value);
           transparent_crc(250U, "g_136", print_hash_value);
           transparent_crc(0, "g_141", print_hash_value);
           ;

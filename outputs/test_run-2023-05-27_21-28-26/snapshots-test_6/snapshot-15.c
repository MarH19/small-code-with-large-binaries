 unsigned long int __u_long;
        ...
        __uint32_t crc32_tab_0;
                __uint32_t crc32_context = 0xFUL;
                __uint32_t crc32_gentab_crc;
const __uint32_t crc32_gentab_poly = 230196000UL;
int crc32_gentab_i;
void crc32_gentab () {

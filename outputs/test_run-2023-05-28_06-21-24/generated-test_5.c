...
static struct a g_42 = {1545554634L, 1L - 1L, 4040L, 1L, 0L, 663, 0xEFL};
...
static unsigned short g_270[1] = {0000000};
static unsigned short g_270_0 = 0;
static struct a g_318 = {1545554634L, 1L - 1L, 404, 0L, 1L, 0L, 663, 0xEFL};
...
void(safe_lshift_func_uint8_t_u_s)(void) {
  (((safe_lshift_func_uint8_t_u_s_right) = 32) ||
   (safe_lshift_func_uint8_t_u_s_left > (0 >> 0)))
      ?: (safe_lshift_func_uint8_t_u_s_left << 0);
}

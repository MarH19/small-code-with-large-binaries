 ...
 void  (safe_div_func_uint32_t_u_u)( void ) {                      0 ?      :     (safe_div_func_uint32_t_u_u_ui1 / safe_div_func_uint32_t_u_u_ui2);               }
 ...
 int crc32_gentab_i;
 int crc32_gentab_j;
 void crc32_gentab () {                                                                crc32_gentab_i = 0;                         for (;               0 < 256;               0) {               crc32_gentab_j = 8;                        for (8;             8 > 0;             crc32_gentab_j--)                crc32_tab_0 = 1;              }               }
                 unsigned char crc32_byte_b;
         void crc32_byte (void) {                crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   1;               }
                 struct S0 {                                    __int16_t f1;                  __int32_t f2;                  unsigned f3 ;                  const signed char f4;                  __int32_t f5;                  signed char f6;                  unsigned f7 ;                  signed char f8;               };
                 struct S1 {                  signed char f0;                  unsigned int f1;               };
                 struct S2 {                  signed f0 ;                  signed f1 ;                  unsigned f2 ;                  signed f3 ;               };
                 __int32_t g_8 = 0x31EB2391L;
                 __int32_t g_7 = 0x31EB2391L;
                 struct S0 g_42 ;
                 unsigned int g_110 = 2UL;
                 unsigned short g_112[1] = {                         0xBB5AL,0x6991L,0x6991L,0xBB5AL,0x6991L,0x6991L,0xBB5AL,0x6991L      ,     0xBB5AL,0xBB5AL,65533UL,0xBB5AL,0xBB5AL,65533UL,0xBB5AL,0xBB5AL             };
         ...
         unsigned short g_270_0 = 0;
                 struct S0 g_318 = {              1L-1L,4040L,1L,0L,663,0xEFL};
                 const __int32_t g_390[1] = {       0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L};
 ...
 unsigned short func_24_p_25;
                  void  func_31( void);
 void  func_31( void) {                                  }
         unsigned char func_31_l_36[1] = {                          0x23L,0x7DL,0UL     ,    247UL,246UL,0x9BL     ,    255UL,9UL,0xD8L     ,    0xC8L,9UL,255UL     ,    250UL,246UL,0x82L     ,    255UL,255UL,0x7DL     ,    247UL,255UL,0x82L     ,    0x23L,255UL,255UL     ,{        0x42L,0UL,0xD8L}          ,{        0x9BL,0x63L,250UL}                      ,              0UL,1UL,0x9CL     ,    0UL,0x32L,0xB9L                 };
 ...
 __int32_t func_1_l_16[1] = {      0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L};
 __int32_t func_1_l_22 = 0;
 __int32_t func_1_l_27 = 00;
 __int32_t func_1_l_772 = 1L;
                   int main (void) {                   {                                     __int32_t __trans_tmp_1;                                                                                                                                                                                                                                                                                                                                                                                                                                                            {                                                                                                              __trans_tmp_1 =  func_24_l_28;                                                   }                                                                          func_1___trans_tmp_5 = func_24_l_28;                                     func_1___trans_tmp_3 = 0;                                     func_1___trans_tmp_1 = 0;                                     {                                           }                                                 (*g_389) = ( (void*)0);                                 }                                      ;               }

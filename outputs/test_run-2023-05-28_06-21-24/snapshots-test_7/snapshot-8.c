  ...
  static __uint32_t crc32_tab_0;
         ...
         i = 0;
                  for (0;
        0 < 256;
        i++) {         j = 8;                  for (j;       j > 0;       j--) {         crc & 1;                   {         crc = (crc >> 1) ^ 0xEDB88320UL;        }       {         crc >>= 1;        }        }         crc32_tab_0 = 1;        }
        }
...
0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L};
  ...
  void  func_31( void) {
          ...
          void  func_1(void) {
            ...
            __int32_t l_16[1] = {0x31EB2391L,0x31EB2391L,0x31EB2391L,0x31EB2391L};
            ...
            {__int32_t *p_19 = __trans_tmp_5;                                   __trans_tmp_6 =  (0x31EB2391L);                   }
                        __trans_tmp_4 = 0x31EB2391L;
            __trans_tmp_3 = 0;
            __trans_tmp_2 = 0;
            __trans_tmp_1 = 0;
            {signed char si1 = (__trans_tmp_1);                                 __trans_tmp_7 =      ((__trans_tmp_1) + safe_add_func_int8_t_s_s_si2);                   }
                        ((g_7) = (~(__trans_tmp_7)));
                        (*g_389) = ( (void*)0);
             (*l_27);
        }

...
static int16_t g_1676_0 = 0L;
   ...
   0xF4L,1L,0x48L,(-1L),(-1L),0x48L}
       ...
       i++)         l_1726_0 = 0xED5D79DAL;
        ...
        int main (void) {
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_141", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_144", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_517", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_529", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_533", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_540", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }
      ...
      j < 9;
      j++)         {
                 {char *vname = "g_588[i][j]";
                 int flag = 0;
                 
                         crc32_8bytes();
                         if (0) {
                           printf("...checksum after hashing %s : %lX\n", "g_588[i][j]", crc32_context ^ 0xFFFFFFFFUL);
                        }
                        }
           ...
           int flag = 0;
                   ...
                   crc32_8bytes();
                   if (0) {
                     printf("...checksum after hashing %s : %lX\n", "g_1273", crc32_context ^ 0xFFFFFFFFUL);
                  }
                  }

...
static int16_t g_1676_0 = 0L;
   ...
   0xF4L,1L,0x48L,(-1L),(-1L),0x48L}
      ...
      j++)             l_1189_0_0 = 0x3288C8DEL;
       ...
       i++)         l_1726_0 = 0xED5D79DAL;
        ...
        int main (void) {
           ...
           transparent_crc( "g_144", print_hash_value);
           transparent_crc( "g_517", print_hash_value);
           transparent_crc( "g_529", print_hash_value);
           transparent_crc( "g_533", print_hash_value);
           {char *vname = "g_540";
      ...
      j < 9;
      j++)         {
                 transparent_crc( "g_588[i][j]", print_hash_value);
                 if (print_hash_value) printf("index = [%d][%d]\n", i, j);
             }
          }
           transparent_crc( "g_1273", print_hash_value);
           transparent_crc( "g_1340", print_hash_value);
           transparent_crc( "g_1573", print_hash_value);
           transparent_crc( "g_1594", print_hash_value);
           for (i = 0;
       i < 1;
       i++)     {
              transparent_crc( "g_1676[i]", print_hash_value);

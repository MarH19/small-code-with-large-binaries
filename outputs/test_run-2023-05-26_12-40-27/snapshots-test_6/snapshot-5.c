...
static int64_t (safe_sub_func_int64_t_s_s)(int64_t si1 ) {
         return     (((si1^safe_sub_func_int64_t_s_s_si2) & (((si1 ^ ((si1^safe_sub_func_int64_t_s_s_si2) & (~(9223372036854775807L))))-safe_sub_func_int64_t_s_s_si2)^safe_sub_func_int64_t_s_s_si2)) < 0) ?     ((si1)) :     (si1 - safe_sub_func_int64_t_s_s_si2);
       }
     ...
     7,0,14275,80,1002,7194,7UL,-138};
       ...
       --g_2)     {
              ...
              if ((+(((g_317 , ((*l_1137) = l_1136)) == l_1136) ^ (((*l_1138) = &g_674) == &g_674))))         {
                 ...
                 int32_t l_1166 = 1L;
                 if (((*g_987) , ((g_1007 = g_1007) != (((safe_mod_func_int64_t_s_s((safe_sub_func_int64_t_s_s((((g_271_1 , 0UL) != (**g_133)) <= (*l_8)))), (safe_add_func_int8_t_s_s( )))) >= g_126) , l_1148))))             {
                    return g_271;
                    uint8_t l_1150 = 0UL;

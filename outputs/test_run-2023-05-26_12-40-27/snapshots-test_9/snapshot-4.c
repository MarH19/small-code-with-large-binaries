 typedef signed char __int8_t;
     ...
     --g_2)     {
      ...
      static int32_t * func_56(int32_t * p_57, int32_t * p_58, struct S0 p_59) {
         if ((**g_133))     {
            for (g_128 = 4;
    (g_128 >= 17);
    g_128 = safe_add_func_uint16_t_u_u(g_128, 2))         {
               return (*g_133);
           }
        }
     lbl_459:     for (g_7 = (-14);
     ...
     g_205++)     {
            int32_t *l_249 = &g_132;
            struct S0 l_250 = {
  0,0,-19585,-908,1255,991,0x9304CBFAB05A5867LL,-198};
            if ((l_250 , (*g_100)))         {
               uint16_t l_251 = 0UL;
               if (l_251)             {
                  for (g_132 = (-4);
  ...
  g_132++)                 {
                  ...
                  if (p_76)                 {
                     for (g_317 = (-30);
 (g_317 > 1);
 g_317 = safe_add_func_uint64_t_u_u(g_317, 1))                     {
                     }
                 }
                  else                 {
                     return g_271;

...
static uint8_t (safe_lshift_func_uint8_t_u_s)(uint8_t left ) {
         return     ((((int)safe_lshift_func_uint8_t_u_s_right) < 0) || (((int)safe_lshift_func_uint8_t_u_s_right) >= 32) || (left > ((255) >> ((int)safe_lshift_func_uint8_t_u_s_right)))) ?     ((left)) :     (left << ((int)safe_lshift_func_uint8_t_u_s_right));
       }

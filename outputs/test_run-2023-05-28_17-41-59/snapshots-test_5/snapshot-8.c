 typedef signed char __int8_t;
        ...
        void  (safe_lshift_func_uint8_t_u_u)( void ) {
                     ((((unsigned int)safe_lshift_func_uint8_t_u_u_right) >= 32) || (safe_lshift_func_uint8_t_u_u_left > (0 >> ((unsigned int)safe_lshift_func_uint8_t_u_u_right)))) ?     ((safe_lshift_func_uint8_t_u_u_left)) :     (safe_lshift_func_uint8_t_u_u_left << ((int)safe_lshift_func_uint8_t_u_u_right));
              }

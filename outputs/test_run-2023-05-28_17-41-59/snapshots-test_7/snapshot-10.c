...
void(safe_lshift_func_uint16_t_u_s)(void) {
  ((((int)safe_lshift_func_uint16_t_u_s_right) < 0) ||
   (((int)safe_lshift_func_uint16_t_u_s_right) >= 32) ||
   (safe_lshift_func_uint16_t_u_s_left >
    ((65535) >> ((int)safe_lshift_func_uint16_t_u_s_right))))
      ? ((safe_lshift_func_uint16_t_u_s_left))
      : (safe_lshift_func_uint16_t_u_s_left
         << ((int)safe_lshift_func_uint16_t_u_s_right));
}
...
void func_1(void) {
  ...
  for (g_73; (g_73 > 22); g_73++) {
    ...
    {
      __trans_tmp_1 = ((safe_rshift_func_int8_t_s_s_left < 0) ||
    ...
    ((g_73 >= (((0xF5A2F617 >=
                 (((__trans_tmp_1) ==
                   ((254U == (g_515 == (((__trans_tmp_2) == 2U) || 253U))) &
                    0xB3198A8F)) |
                  0x797B69E0)) |
                0x5C) &&
               0x14FDFC62)) > 0xBB);

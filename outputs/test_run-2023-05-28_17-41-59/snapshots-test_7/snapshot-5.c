...
static int16_t (safe_rshift_func_int16_t_s_u)( unsigned int right ) {
         return     ((safe_rshift_func_int16_t_s_u_left < 0) || (((unsigned int)right) >= 32)) ?     ((safe_rshift_func_int16_t_s_u_left)) :     (safe_rshift_func_int16_t_s_u_left >> ((unsigned int)right));
       }

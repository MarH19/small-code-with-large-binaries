                                   typedef short __int16_t;
                                         typedef int __int32_t;
                                                                                               signed safe_add_func_int8_t_s_s_si2;
...
void  (safe_lshift_func_uint16_t_u_s)( void ) {
                ...
                void  (safe_rshift_func_uint16_t_u_s)( void ) {
                            (((safe_rshift_func_uint16_t_u_s_right) < 0) || (((int)safe_rshift_func_uint16_t_u_s_right) >= 2)) ?     ((safe_rshift_func_uint16_t_u_s_left)) :     (safe_rshift_func_uint16_t_u_s_left >> ((int)safe_rshift_func_uint16_t_u_s_right));

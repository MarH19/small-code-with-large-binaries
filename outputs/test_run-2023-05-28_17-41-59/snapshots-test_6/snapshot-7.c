  ...
  int transparent_crc_flag;
          ...
          void  func_1(void) {
            ...
            g_73 = (-30);
                        for (g_73;
        (g_73 > 22);
        g_73++)     {               __uint8_t l_668 = 249U;               __uint8_t l_693 = 255U;               const __int32_t l_789 = 1;               {                        __trans_tmp_1 =      ((safe_rshift_func_int8_t_s_s_left < 0) || (((int)safe_rshift_func_int8_t_s_s_right) < 0) || (((int)safe_rshift_func_int8_t_s_s_right) >= 32))?     ((safe_rshift_func_int8_t_s_s_left)) :     (safe_rshift_func_int8_t_s_s_left >> ((int)safe_rshift_func_int8_t_s_s_right));                      }                              {                        __trans_tmp_2 =      ((safe_lshift_func_int16_t_s_u_left < 0) || (((unsigned int)safe_lshift_func_int16_t_s_u_right) >= 32) || (safe_lshift_func_int16_t_s_u_left > ((32767) >> ((unsigned int)safe_lshift_func_int16_t_s_u_right)))) ?     ((safe_lshift_func_int16_t_s_u_left)) :     (safe_lshift_func_int16_t_s_u_left << ((unsigned int)safe_lshift_func_int16_t_s_u_right));                      }                              ((g_73 >= (((0xF5A2F617 >= (((__trans_tmp_1) == ((254U == (g_515 == (((__trans_tmp_2) == 2U) || 253U))) & 0xB3198A8F)) | 0x797B69E0)) | 0x5C) && 0x14FDFC62)) > 0xBB);                               1;                         }
        }
  const __uint32_t func_5_p_9;
  void  func_5(   void) {
             9U;
        }
          __int16_t func_46_p_47;
  __uint8_t func_46_p_48;
  void  func_46( void) {
             func_46_p_48;
        }
          __int16_t func_95_p_96;
  __int32_t func_95_p_97;
  __int32_t func_95_p_98;
  void  func_95(  void) {
             func_95_p_97;
        }
          int main (void) {

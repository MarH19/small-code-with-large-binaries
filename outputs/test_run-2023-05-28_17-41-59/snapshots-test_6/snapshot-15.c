          ...
          int transparent_crc_flag;
                   unsigned int g_2 = 3004795535;
                  unsigned int g_39 = 4121097751;
                  unsigned int g_54 = 2888062833;
                  __int32_t g_60 = 2038131168;
                  __int16_t g_65 = 0;
                  __int16_t g_67 = 0;
                  unsigned int g_73 = 7U;
                  unsigned char g_194 = 9U;
                  unsigned int g_200 = 4057220810;
                  __int32_t g_225 = 1565928383;
                  unsigned int g_226 = 0x14FDFC62;
                  unsigned char g_259 = 253U;
                  unsigned int g_263 = 3367015737;
                  unsigned char g_311 = 1U;
                  unsigned char g_372 = 0x5C;
                  signed char g_515 = 0;
                  unsigned int g_662 = 0U;
                  signed char g_692 = 0x73;
                  unsigned int g_739 = 0x20CCCE2B;
                  unsigned char g_760 = 8U;
                  unsigned int g_788 = 4294967294U;
                  __int16_t func_1___trans_tmp_2;
  signed char func_1___trans_tmp_1;
  unsigned char func_1_l_18 = 0xBB;
  void  func_1() {
                                                                                                                                                 for (;
               ;
               g_73)     {                                          {                             func_1___trans_tmp_1 =      ((safe_rshift_func_int8_t_s_s_left < 0) || (((int)safe_rshift_func_int8_t_s_s_right) < 0) || (((int)safe_rshift_func_int8_t_s_s_right) >= 32))?     ((safe_rshift_func_int8_t_s_s_left)) :     (safe_rshift_func_int8_t_s_s_left >> ((int)safe_rshift_func_int8_t_s_s_right));                           }                                    {                             func_1___trans_tmp_2 =      ((safe_lshift_func_int16_t_s_u_left < 0) || (((unsigned int)safe_lshift_func_int16_t_s_u_right) >= 32) || (safe_lshift_func_int16_t_s_u_left > (0 >> ((unsigned int)safe_lshift_func_int16_t_s_u_right)))) ?     ((safe_lshift_func_int16_t_s_u_left)) :     (safe_lshift_func_int16_t_s_u_left << ((unsigned int)safe_lshift_func_int16_t_s_u_right));                           }                                    ((g_73 >= (((4121097751 >= (((func_1___trans_tmp_1) == ((254U == (g_515 == (((func_1___trans_tmp_2) == 2U) || 253U))) & 3004795535)) | 2038131168)) | 0x5C) && 0x14FDFC62)) > 0xBB);                               }
               }
                  int main (void) {

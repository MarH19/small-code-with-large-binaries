...
static uint16_t (safe_rshift_func_uint16_t_u_s)( void ) {
         ...
         return     (((unsigned int)safe_rshift_func_uint16_t_u_s_right) >= 32) ?     ((safe_rshift_func_uint16_t_u_s_left)) :     (safe_rshift_func_uint16_t_u_s_left >> ((unsigned int)safe_rshift_func_uint16_t_u_s_right));
       }
...
static void transparent_crc (  void) {
       ...
       g_73++)     {
        ...
        int32_t func_5_p_6;
int8_t func_5_p_7;
static int16_t func_5(  uint32_t p_8, const uint32_t p_9) {
           return g_194;
       }

         ...
         int safe_lshift_func_int8_t_s_s_right;
                  signed char safe_rshift_func_int8_t_s_s_left;
         ...
         void  (safe_lshift_func_uint8_t_u_u)( void ) {                      (((safe_lshift_func_uint8_t_u_u_right) >= 2) || (safe_lshift_func_uint8_t_u_u_left > (0 >> (safe_lshift_func_uint8_t_u_u_right)))) ?     ((safe_lshift_func_uint8_t_u_u_left)) :     (safe_lshift_func_uint8_t_u_u_left << (safe_lshift_func_uint8_t_u_u_right));               }
         ...
         void  (safe_mul_func_uint16_t_u_u)( void ) {                  (safe_mul_func_uint16_t_u_u_ui1) * ((unsigned int)safe_mul_func_uint16_t_u_u_ui2);               }
                  unsigned short safe_lshift_func_uint16_t_u_s_left;
         int safe_lshift_func_uint16_t_u_s_right;
         void  (safe_lshift_func_uint16_t_u_s)( void ) {                      ((((int)safe_lshift_func_uint16_t_u_s_right) < 0) || (((int)safe_lshift_func_uint16_t_u_s_right) >= 2) || (safe_lshift_func_uint16_t_u_s_left > (0 >> ((int)safe_lshift_func_uint16_t_u_s_right)))) ?     ((safe_lshift_func_uint16_t_u_s_left)) :     (safe_lshift_func_uint16_t_u_s_left << ((int)safe_lshift_func_uint16_t_u_s_right));               }
                 unsigned short safe_lshift_func_uint16_t_u_u_left;
         unsigned int safe_lshift_func_uint16_t_u_u_right;
         void  (safe_lshift_func_uint16_t_u_u)( void ) {                      ((((unsigned int)safe_lshift_func_uint16_t_u_u_right) >= 2) || (safe_lshift_func_uint16_t_u_u_left > (0 >> ((unsigned int)safe_lshift_func_uint16_t_u_u_right)))) ?     ((safe_lshift_func_uint16_t_u_u_left)) :     (safe_lshift_func_uint16_t_u_u_left << ((unsigned int)safe_lshift_func_uint16_t_u_u_right));               }
                 unsigned short safe_rshift_func_uint16_t_u_s_left;
         int safe_rshift_func_uint16_t_u_s_right;
         void  (safe_rshift_func_uint16_t_u_s)( void ) {                      ((((int)safe_rshift_func_uint16_t_u_s_right) < 0) || (((int)safe_rshift_func_uint16_t_u_s_right) >= 32)) ?     ((safe_rshift_func_uint16_t_u_s_left)) :     (safe_rshift_func_uint16_t_u_s_left >> ((int)safe_rshift_func_uint16_t_u_s_right));                      (((unsigned int)safe_rshift_func_uint16_t_u_s_right) >= 32) ?     ((safe_rshift_func_uint16_t_u_s_left)) :     (safe_rshift_func_uint16_t_u_s_left >> ((unsigned int)safe_rshift_func_uint16_t_u_s_right));               }
         ...
         static unsigned int crc32_tab_0;
                 ...
                 static __int32_t g_225 = 1565928383;
                 static unsigned int g_226 = 0x14FDFC62;
                 static unsigned char g_259 = 253U;
                 static unsigned int g_263 = 3367015737;
                 static unsigned char g_311 = 1U;
                 static unsigned char g_372 = 0x5C;
                 static signed char g_515 = (5);
                 static unsigned int g_662 = 0U;
                 static const signed char g_692 = 0x73;
                 static unsigned int g_739 = 0x20CCCE2B;
                 static unsigned char g_760 = 8U;
                 static unsigned int g_788 = 4294967294U;
                 __int16_t func_1___trans_tmp_2;
 signed char func_1___trans_tmp_1;
 void  func_1(void) {                                                                                        for (g_73;               (g_73 > 22);               g_73++)     {                                          {                             func_1___trans_tmp_1 =      ((safe_rshift_func_int8_t_s_s_left < 0) || (((int)safe_rshift_func_int8_t_s_s_right) < 0) || (((int)safe_rshift_func_int8_t_s_s_right) >= 32))?     ((safe_rshift_func_int8_t_s_s_left)) :     (safe_rshift_func_int8_t_s_s_left >> ((int)safe_rshift_func_int8_t_s_s_right));                             func_1___trans_tmp_2 =      ((safe_lshift_func_int16_t_s_u_left < 0) || (((unsigned int)safe_lshift_func_int16_t_s_u_right) >= 32) || (safe_lshift_func_int16_t_s_u_left > ((32767) >> ((unsigned int)safe_lshift_func_int16_t_s_u_right)))) ?     ((safe_lshift_func_int16_t_s_u_left)) :     (safe_lshift_func_int16_t_s_u_left << ((unsigned int)safe_lshift_func_int16_t_s_u_right));                           }                                    ((g_73 >= (((4121097751 >= (((func_1___trans_tmp_1) == ((254U == (g_515 == (((func_1___trans_tmp_2) == 2U) || 253U))) & 3004795535)) | 2038131168)) | 0x5C) && 0x14FDFC62)) > 0xBB)                                     ;                               }               }
                 int main (void) {                   {                          {                                 {                                        crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   crc32_tab_0;                                       }                                }                         }               }

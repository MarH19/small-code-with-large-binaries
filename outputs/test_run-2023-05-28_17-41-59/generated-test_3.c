...
static unsigned int b = 4121097751;
...
void(safe_lshift_func_uint8_t_u_u)(void) {
  (((safe_lshift_func_uint8_t_u_u_right) >= 2) ||
...
void(safe_lshift_func_uint16_t_u_s)(void) {
  ((((int)safe_lshift_func_uint16_t_u_s_right) < 0) ||
   (((int)safe_lshift_func_uint16_t_u_s_right) >= 2) ||
   (safe_lshift_func_uint16_t_u_s_left >
    (0 >> ((int)safe_lshift_func_uint16_t_u_s_right))))
      ? ((safe_lshift_func_uint16_t_u_s_left))
      : (safe_lshift_func_uint16_t_u_s_left
         << ((int)safe_lshift_func_uint16_t_u_s_right));
}
void(safe_lshift_func_uint16_t_u_u)(void) {
  ((((unsigned int)safe_lshift_func_uint16_t_u_u_right) >= 2) ||
...
void(safe_rshift_func_uint16_t_u_s)(void) {
  ((((int)safe_rshift_func_uint16_t_u_s_right) < 0) ||
   (((int)safe_rshift_func_uint16_t_u_s_right) >= 32))
      ...
      func_1___trans_tmp_2 =
          ((safe_lshift_func_int16_t_s_u_left < 0) ||
           ...
           (safe_lshift_func_int16_t_s_u_left >
            ((32767) >> ((unsigned int)safe_lshift_func_int16_t_s_u_right))))
              ? ((safe_lshift_func_int16_t_s_u_left))
              : (safe_lshift_func_int16_t_s_u_left
                 << ((unsigned int)safe_lshift_func_int16_t_s_u_right));
    }

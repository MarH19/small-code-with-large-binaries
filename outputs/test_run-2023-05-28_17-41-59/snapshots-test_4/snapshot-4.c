...
static uint8_t (safe_rshift_func_uint8_t_u_u)( unsigned int right ) {
         return     (((unsigned int)right) >= 32) ?     ((safe_rshift_func_uint8_t_u_u_left)) :     (safe_rshift_func_uint8_t_u_u_left >> ((unsigned int)right));
       }
        static uint16_t (safe_mul_func_uint16_t_u_u)(uint16_t ui1, uint16_t ui2 ) {
         return ((unsigned int)ui1) * ((unsigned int)ui2);
       }
         uint16_t safe_lshift_func_uint16_t_u_s_left;
static uint16_t (safe_lshift_func_uint16_t_u_s)( int right ) {
         return     ((((int)right) < 0) || (((int)right) >= 32) || (safe_lshift_func_uint16_t_u_s_left > ((65535) >> ((int)right)))) ?     ((safe_lshift_func_uint16_t_u_s_left)) :     (safe_lshift_func_uint16_t_u_s_left << ((int)right));
       }

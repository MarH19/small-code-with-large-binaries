  ...
  void  func_13( void) {
            ...
            {                     __trans_tmp_1 =  safe_add_func_uint32_t_u_u_ui1 + safe_add_func_uint32_t_u_u_ui2;                   }
                        ...
                        for (__trans_tmp_1;
        (__trans_tmp_1 < 4);
        __trans_tmp_1)     {               g_621 = 0;                              g_621 = 0;                              for (g_621;       (g_621 < 19);       g_621)         {                  __int32_t l_680 = 0L;                   &l_681;              }           }
        }

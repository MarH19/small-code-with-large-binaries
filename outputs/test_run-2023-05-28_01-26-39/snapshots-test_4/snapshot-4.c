...
static uint16_t (safe_lshift_func_uint16_t_u_u)(uint16_t left ) {
         return     ((((unsigned int)safe_lshift_func_uint16_t_u_u_right) >= 32) || (left > ((65535) >> ((unsigned int)safe_lshift_func_uint16_t_u_u_right)))) ?     ((left)) :     (left << ((unsigned int)safe_lshift_func_uint16_t_u_u_right));
       }

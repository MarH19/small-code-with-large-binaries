...
void  func_71(void) {
                  ...
                  __uint32_t __trans_tmp_7;
                  signed char __trans_tmp_6;
                  __uint16_t __trans_tmp_5;
            ...
            (__trans_tmp_5 < 8);
            __trans_tmp_5)         {
                      const __int32_t l_82 = 0xB4837182L;
                      (void) sizeof ((&g_83 == &l_75) ? 1 : 0);
                                        ( __extension__ ({
        }
         ));
                      {

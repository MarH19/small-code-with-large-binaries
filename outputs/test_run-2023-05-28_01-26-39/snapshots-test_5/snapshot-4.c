...
static int16_t (safe_lshift_func_int16_t_s_u)(int16_t left ) {
         return     ((left < 0) || (((unsigned int)safe_lshift_func_int16_t_s_u_right) >= 32) || (left > ((32767) >> ((unsigned int)safe_lshift_func_int16_t_s_u_right)))) ?     ((left)) :     (left << ((unsigned int)safe_lshift_func_int16_t_s_u_right));
       }

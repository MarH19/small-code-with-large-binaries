...
static uint8_t (safe_add_func_uint8_t_u_u)( uint8_t ui2 ) {
         return safe_add_func_uint8_t_u_u_ui1 + ui2;
       }
        static uint8_t (safe_sub_func_uint8_t_u_u)(uint8_t ui1, uint8_t ui2 ) {
         return ui1 - ui2;
       }
             uint8_t safe_rshift_func_uint8_t_u_s_left;
static uint8_t (safe_rshift_func_uint8_t_u_s)( int right ) {
         return     ((((int)right) < 0) || (((int)right) >= 32)) ?     ((safe_rshift_func_uint8_t_u_s_left)) :     (safe_rshift_func_uint8_t_u_s_left >> ((int)right));
       }
...
static uint32_t *g_412_3_0;
      ...
      {
     &g_412[2][0], &g_412_3_0, &g_412[2][0], &g_412_1_0, &g_412[2][0], &g_412_3_0, &g_412[2][0], &g_412_1_0, &g_412[2][0], &g_412[2][0]}
      , {
     &g_412[2][0], &g_412_3_0, &g_412[2][0], &g_412_1_0, &g_412[2][0], &g_412_3_0, &g_412[2][0], &g_412_1_0, &g_412[2][0], &g_412[2][0]}
      , {
     &g_412[2][0], &g_412_3_0, &g_412[2][0], &g_412_1_0, &g_412[2][0], &g_412_3_0, &g_412[2][0], &g_412_1_0, &g_412[2][0], &g_412[2][0]}
...
static uint32_t **g_772_0 = (void*)0;
   ...
   &g_85, &g_20, &g_85, (void*)0, &g_85, &g_87, &g_20}
    ...
    &g_552, (void*)0}
           ...
           (***g_552) = func_2(((**g_269) = (((*g_792) = (safe_rshift_func_uint8_t_u_s( 2))) | (!(g_128 | l_16)))), l_921_1_1_6);

...
(void*)0,(void*)0};
          ...
          void  func_17(void);
  void  func_17(void) {
            unsigned short l_28 = 1UL;
             (0xA2L);
        }
          void  func_1(void) {
            __int32_t __trans_tmp_1;
            signed char l_16 = 1L;
            __int32_t l_921[112] = {0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L,0,0x0CBEB969L,0,0,0,1L,0x0CBEB969L};
            ...
            g_90 = 0;
                        for (0;
        (0 >= 57);
        g_90++)     {               __int32_t l_937 = (-7L);               __int32_t l_938 = 0x8C267EBAL;               __uint32_t l_956 = 0;               __int32_t l_976 = **g_73;               const signed char l_977 = 1L;               __uint32_t l_1142[1][1] = {{0UL,1UL,0UL,1UL,0UL,1UL,0UL,1UL},{0UL,1UL,0UL,1UL,0UL,1UL,0UL,1UL},{0UL,1UL,0UL,1UL,0UL,1UL,0UL,1UL}};               int i, j;           }
             0L;
        }
           const __int32_t  func_17_p_18;
           int main (void) {
            int print_hash_value = 0;
            {                    ;                    transparent_crc_flag;                                         {                      0;                                            (0);                                            (0);                                            (0);                   }                   }
                        ;
            {                    crc32_8bytes();                    transparent_crc_flag;                                         {                      printf("...checksum after hashing %s : %lX\n", &transparent_crc_vname, crc32_context ^ 0xFFFFFFFFUL);                   }                   }
                        ;
        }

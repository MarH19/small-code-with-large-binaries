...
static void platform_main_end( int flag) {
...
static int8_t (safe_rshift_func_int8_t_s_u)( unsigned int right ) {
         return     (0 || (((unsigned int)right) >= 32)) ?     ((safe_rshift_func_int8_t_s_u_left)) :     (safe_rshift_func_int8_t_s_u_left >> ((unsigned int)right));
         return     ((safe_rshift_func_int8_t_s_u_left < 0) || (((unsigned int)right) >= 32) || (safe_rshift_func_int8_t_s_u_left > ((32767) >> ((unsigned int)right)))) ?     ((safe_rshift_func_int8_t_s_u_left)) :     (safe_rshift_func_int8_t_s_u_left << ((unsigned int)right));
       }

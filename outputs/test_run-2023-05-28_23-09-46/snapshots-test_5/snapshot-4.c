...
static int8_t (safe_rshift_func_int8_t_s_u)( unsigned int right ) {
         return     ((safe_rshift_func_int8_t_s_u_left < 0) || (((unsigned int)right) >= 32)) ?     ((safe_rshift_func_int8_t_s_u_left)) :     (safe_rshift_func_int8_t_s_u_left >> ((unsigned int)right));
       }
...
static int32_t (safe_sub_func_int32_t_s_s)( int32_t si2 ) {
         ...
         return     ((si2 == 0) || ((safe_sub_func_int32_t_s_s_si1 == (-2147483647-1)) && (si2 == (-1)))) ?     ((safe_sub_func_int32_t_s_s_si1)) :     (safe_sub_func_int32_t_s_s_si1 % si2);
       }
...
static uint8_t *g_364_1_2;
     ...
     g_376--)             {
                    ...
                    int32_t l_732 = (-1);
                    int16_t *l_733 = &g_83;
                    l_737 = ((*p_11) = (((l_729 = (g_96 = l_728)) & ((safe_rshift_func_int8_t_s_u( ((**g_363) = (**l_674)))) & ((((*l_717) = 0xF5) <= (((g_470 <= l_728) < ((*l_733) = (*l_636))) < (safe_rshift_func_uint8_t_u_u(((void*)0 != (*g_275)), l_736)))) < (**g_393)))) > 3U));
                    return (**l_674);
                }
             }
          }

...
static int32_t (safe_sub_func_int32_t_s_s)( void ) {
         ...
         return     ((safe_sub_func_int32_t_s_s_si2 == 0) || ((safe_sub_func_int32_t_s_s_si1 == (-2147483647-1)) && (safe_sub_func_int32_t_s_s_si2 == (-1)))) ?     ((safe_sub_func_int32_t_s_s_si1)) :     (safe_sub_func_int32_t_s_s_si1 % safe_sub_func_int32_t_s_s_si2);
       }
...
static uint32_t (safe_add_func_uint32_t_u_u)( void ) {
         ...
         return     (safe_add_func_uint32_t_u_u_ui2 == 0) ?     ((safe_add_func_uint32_t_u_u_ui1)) :     (safe_add_func_uint32_t_u_u_ui1 / safe_add_func_uint32_t_u_u_ui2);
       }
...
static uint16_t func_10(void) {
     ...
     g_376--)             {
                    ...
                    int32_t l_732 = (-1);
                    int16_t *l_733 = &g_83;
                    l_737 = ((*func_10_p_11) = (((l_729 = (g_96 = l_728)) & ((safe_rshift_func_int8_t_s_u( )) & ((((*l_717) = 0xF5) <= (((g_470 <= l_728) < ((*l_733) = (*l_636))) < (safe_rshift_func_uint8_t_u_u( )))) < (**g_393)))) > 3U));
                    return (**l_674);
                }
             }
          }

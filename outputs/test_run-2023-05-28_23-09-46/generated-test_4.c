...
void func_1(void) {
  {
    func_1___trans_tmp_1 =
        ((safe_div_func_int8_t_s_s_si2 == 0) ||
         ((safe_div_func_int8_t_s_s_si1 == 0) &&
          (safe_div_func_int8_t_s_s_si2 == 0)))
          ...
          {
            {
              func_10___trans_tmp_2 =
                  ((safe_rshift_func_int8_t_s_u_left < 0) ||
                   (((unsigned int)safe_rshift_func_int8_t_s_u_right) >= 32))

        ...
        void  func_10(void) {
             ...
             g_376--)             {
                                                                                                                          {
                          {
                                 func_10___trans_tmp_2 =      ((safe_rshift_func_int8_t_s_u_left < 0) || 0) ?     ((safe_rshift_func_int8_t_s_u_left)) :     (safe_rshift_func_int8_t_s_u_left >> ((unsigned int)safe_rshift_func_int8_t_s_u_right));
                        {

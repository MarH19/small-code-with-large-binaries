      ...
      void  func_10(void) {
       ...
       g_376--)             {
                     ...
                     {                              __trans_tmp_2 =      ((safe_rshift_func_int8_t_s_u_left < 0) || (((unsigned int)safe_rshift_func_int8_t_s_u_right) >= 32)) ?     ((safe_rshift_func_int8_t_s_u_left)) :     (safe_rshift_func_int8_t_s_u_left >> ((unsigned int)safe_rshift_func_int8_t_s_u_right));                            }
                                          {                     {                              __trans_tmp_3 =      (((unsigned int)safe_rshift_func_uint8_t_u_u_right) >= 32) ?     ((safe_rshift_func_uint8_t_u_u_left)) :     (safe_rshift_func_uint8_t_u_u_left >> ((unsigned int)safe_rshift_func_uint8_t_u_u_right));                            }                                          l_737 = ((func_10_p_11) = (((l_729 = (g_96 = 0x03766958)) & ((__trans_tmp_2) & ((((l_717) = 0xF5) <= (((0x45 <= 0x03766958) < ((l_733) = (g_27))) < (__trans_tmp_3))) < (0)))) > 3U));                     }
                     }
                      (g_26);
                 }
                   }

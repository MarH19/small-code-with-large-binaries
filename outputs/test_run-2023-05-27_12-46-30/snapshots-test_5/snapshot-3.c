...
static uint32_t crc32_tab_0;
      ...
      l_334 = safe_add_func_int32_t_s_s( ))         {
                 int64_t *l_349 = &g_130;
                 int32_t l_350 = 6L;
                 (*l_302) |= (0x93L | (p_25 ^ (0xFC80131CL >= (safe_mul_func_uint16_t_u_u(1UL, (p_25 <= ((*l_335) = (0x7AL > ((((safe_sub_func_uint32_t_u_u(((3L >= 0x9FL) >= (safe_sub_func_int64_t_s_s( ))), l_351)) , 4UL) ^ g_337) , 0x6EL)))))))));
             }
          }
           return (*g_160);
       }

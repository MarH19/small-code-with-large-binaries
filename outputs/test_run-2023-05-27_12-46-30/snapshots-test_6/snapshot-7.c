    ...
    void  func_22(  void) {
        ...
        __trans_tmp_3)         {
                  ...
                  __int32_t l_350 = 6L;
                  {                           __trans_tmp_4 =  ((unsigned int)safe_mul_func_uint16_t_u_u_ui1) * ((unsigned int)safe_mul_func_uint16_t_u_u_ui2);                           __trans_tmp_4 =      (safe_mul_func_uint16_t_u_u_ui2 == 0) ?     ((safe_mul_func_uint16_t_u_u_ui1)) :     (safe_mul_func_uint16_t_u_u_ui1 % safe_mul_func_uint16_t_u_u_ui2);                         }

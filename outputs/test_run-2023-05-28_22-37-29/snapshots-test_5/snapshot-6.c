...
static uint32_t crc32_tab_0;
      ...
      j--) {
        ...
        {
                crc32_byte ((crc32_8bytes_val>>0) & 0xff);
                crc32_byte ((crc32_8bytes_val>>8) & 0xff);
                crc32_byte ((crc32_8bytes_val>>16) & 0xff);
                crc32_byte ((crc32_8bytes_val>>24) & 0xff);
                crc32_byte ((crc32_8bytes_val>>32) & 0xff);
                crc32_byte ((crc32_8bytes_val>>40) & 0xff);
                crc32_byte ((crc32_8bytes_val>>48) & 0xff);
                crc32_byte ((crc32_8bytes_val>>56) & 0xff);
               }

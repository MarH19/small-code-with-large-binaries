...
int main (void) {
                  ...
                  transparent_crc;
                  transparent_crc;
                  transparent_crc(0UL, "g_225g_232", main_print_hash_value);
                  transparent_crc(18446744073709551614UL, "g_235", main_print_hash_value);
                  transparent_crc(0x02198C40L, "g_237", main_print_hash_value);
                  transparent_crc(0x36C9A4CFDDBE10E3LL, "g_242", main_print_hash_value);
                  transparent_crc(1UL, "g_256", main_print_hash_value);
                  transparent_crc(g_270, "g_270", main_print_hash_value);

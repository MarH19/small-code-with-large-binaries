...
static uint8_t (safe_div_func_uint8_t_u_u)( uint8_t ui2 ) {
         return     (ui2 == 0) ?     ((safe_div_func_uint8_t_u_u_ui1)) :     (safe_div_func_uint8_t_u_u_ui1 / ui2);
       }
...
static uint16_t *g_328_3_0_0;
      ...
      0x7B752946,0x7B752946,0x7B752946,0x7B752946,0x7B752946,0x7B752946};
        ...
        static uint16_t func_14(uint16_t p_15) {
           ...
           if ((((g_38 >= (safe_div_func_uint8_t_u_u( l_177))) || l_179) & g_38))     {
              int32_t *l_242 = &l_179;

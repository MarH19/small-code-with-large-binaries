        ...
        void  (safe_rshift_func_uint16_t_u_u)( void ) {
                     (((unsigned int)safe_rshift_func_uint16_t_u_u_right) >= 32) ?     ((safe_rshift_func_uint16_t_u_u_left)) :     (safe_rshift_func_uint16_t_u_u_left >> (( int)safe_rshift_func_uint16_t_u_u_right));
              }

...
static uint8_t (safe_lshift_func_uint8_t_u_s)( int right ) {
         return     ((((int)right) < 0) || (((int)right) >= 32) || (safe_lshift_func_uint8_t_u_s_left > ((255) >> ((int)right)))) ?     ((safe_lshift_func_uint8_t_u_s_left)) :     (safe_lshift_func_uint8_t_u_s_left << ((int)right));
       }
...
static uint16_t *g_328_3_0_0;
      ...
      0x7B752946,0x7B752946,0x7B752946,0x7B752946,0x7B752946,0x7B752946};
        ...
        static uint16_t func_14(uint16_t p_15) {
           ...
           if ((((g_38 >= (safe_div_func_uint8_t_u_u((safe_rshift_func_uint16_t_u_u((g_157_1_5 == (safe_div_func_int32_t_s_s((g_16 || ((safe_mod_func_uint16_t_u_u((((safe_sub_func_int32_t_s_s( )) ^ p_15) , p_15), p_15)) || 0xA2B03852)), g_16))), 2)), l_177))) || l_179) & g_38))     {
              int32_t *l_242 = &l_179;

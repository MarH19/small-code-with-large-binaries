...
static __uint32_t g_331[1][1][1] = {{{4294967295U, 4248564040, 4200592991},
...
void(safe_rshift_func_int16_t_s_u)(void) {
  ((safe_rshift_func_int16_t_s_u_left < 0) ||
   ((safe_rshift_func_int16_t_s_u_right) >= 32))
      ?: (safe_rshift_func_int16_t_s_u_left >>
          ((unsigned)safe_rshift_func_int16_t_s_u_right));
}

          typedef unsigned char __uint8_t;
           ...
           void  (safe_rshift_func_int16_t_s_u)( void ) {
                       ((safe_rshift_func_int16_t_s_u_left < 0) || ((safe_rshift_func_int16_t_s_u_right) >= 32)) ?      :     (safe_rshift_func_int16_t_s_u_left >> ((unsigned int)safe_rshift_func_int16_t_s_u_right));
                }
           ...
           static void transparent_crc (  void) {
                 {
                       {                              crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   crc32_tab_0;                             }
                                        ;
                       {                              crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   crc32_tab_0;                              crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   crc32_tab_0;                             }
                                        ;
                       {                              crc32_context =   ((crc32_context >> 8) & 0x00FFFFFF) ^   crc32_tab_0;                             }
                                        ;
                      }
            ...
            ,{          8U,4294967295U,2451248924}
            ,{          0x2D4D6344,0x2C104672,3286031349}
            ...
            ,{          2463908472,4294967295U,4294967294U}
            ,{          3486464133,4280156707,2400779523}
            ,{          4294967289U,9U,2159465747}
            ,{          4294967295U,0x113F0E6E,0xE1FE8385}
            ,{          1U,0x18D7C328,0U}
            ,{          0U,4294967295U,4294967295U}
            ,{          0U,4294967295U,4294967289U}
            ,{          4294967286U,4248564040,2159465747}
            ,{          0U,3006143554,9U}
            ,{          4294967290U,0x1CDC0773,0x921B171C}
            }
               ,{
            {          4294967290U,4294967293U,4294967286U}
            ,{          4294967295U,4200592991,4248564040}
            ,{          4294967295U,4294967295U,3385945904}
            }
               };

...
static __int32_t g_455[1] = {0x23DCDF5E, 0x23DCDF5E, 0x23DCDF5E, 0x23DCDF5E,
                             0x23DCDF5E, 0x23DCDF5E, 0x23DCDF5E, 0x23DCDF5E};
...
static const unsigned int *const g_776[1] = {0000, 0};
  ...
  (((safe_lshift_func_uint16_t_u_u_right) >= 32) ||
   (safe_lshift_func_uint16_t_u_u_left >
    (0 >> (safe_lshift_func_uint16_t_u_u_right))))
      ?: (safe_lshift_func_uint16_t_u_u_left <= 32)
         ? ((safe_lshift_func_uint16_t_u_u_left))
         : (safe_lshift_func_uint16_t_u_u_left >>
...
void(safe_mod_func_uint32_t_u_u)(void) {
  (safe_mod_func_uint32_t_u_u_ui2 == 0)
      ? ((safe_mod_func_uint32_t_u_u_ui1))
...
void func_56(void) {
  {
    func_56___trans_tmp_2 =
        (((safe_sub_func_int32_t_s_s_si1 ^ safe_sub_func_int32_t_s_s_si2) &
          (((safe_sub_func_int32_t_s_s_si1 ^
             ((safe_sub_func_int32_t_s_s_si1 ^ safe_sub_func_int32_t_s_s_si2) &
              (~(2147483647)))) -
            safe_sub_func_int32_t_s_s_si2) ^
           safe_sub_func_int32_t_s_s_si2)) < 0)
            ? ((safe_sub_func_int32_t_s_s_si1))
            : (safe_sub_func_int32_t_s_s_si1 - safe_sub_func_int32_t_s_s_si2);
  }
  for (func_56___trans_tmp_2; (func_56___trans_tmp_2 <= 0);
       func_56___trans_tmp_2)
    func_56___trans_tmp_2;
}
void func_62(void) {
  for (func_62_p_64; (func_62_p_64 <= (-13)); --b) {
    (void)sizeof((g_1191 == g_411 || g_1191 == 0) ? 1 : 0);
  }
}
int main(void) {
